...
const LocationSelector = () => {
  ...
  return (
    <div
      className={`absolute z-[100] flex flex-col w-full top-[60px] max-h-[300px] overflow-y-scroll border py-4 text-[15.5px] left-1/2 items-start transition-all duration-300 
